...
document.onkeyup = function(event) {
	...
	if(userGuess === computerTurn) {
		wins++; alert("You are Psychic! Play again!"); guessesLeft = 9; guessesSoFar.length = 0; computerTurn++;
	}
	...
	if(guessesLeft === 0) {
		losses++; alert("You are NOT Psychic! Try again!"); guessesLeft = 9; guessesSoFar.length = 0; computerTurn++;
	}
